...
Добавлены моды:
Хар-ки от убийств.     Хар-ки от умений.     Скорость от ловкости.

Добавлена настройка мира, позволяющая менять максимальный показатель хар-к, моды все еще могут изменять этот параметр.
...
Забавно, но вы знали что RenechCDDA сделал трупы зомби бесполезными в дда, потому что ему это не нравится, типо вот цитата 
...
Чел, а ты забавный, иди убейся об стену. Номер коммита 86581, чтоб я не забыл

Ох бля... Опять RenechCDDA, гандон он так то, а не человек. Вообщем забавный штука. Уронишь чтонибудь на базе нпс то это тут же присваивается фракцией нпс, очень круто, спс. Номер коммита 88178

А еще RenechCDDA в коммите 88197 про создание чучел, сразу написал `Okay that's... different. I'm not sure how I feel about this, but I think it does need some basic safeguards. All NPCs and any monsters with the HUMAN species should be exempt.` Иди нахуй кайфолом
...
Уже есть мой [мод](https://hub01-shop.srgnis.com/mod/ks-stalker-med) на это 
...
Учитывая что я сейчас делаю [мод](https://hub01-shop.srgnis.com/mod/ks-acid-puff) на кислотное оружие, то это может стать дополнительным источником кислоты
...
Вернуть старую работу гидравлики
...
Сделать концовку с Адскими гончими
...
вернуть возможность превращать киборгов в компаньонов

NamelessLord сказал добавить "Светящееся елда"

вернуть обратно черту Жажда убийств и прочие не этичные действия

Сделать все виды патрон переснаряжаемыми
